    ...
    <li><?php echo $this->Html->link('Template',array('controller'=>'Certificates','action'=>'template')); ?></li>
    </ul>
    ...
    <div class="block-title">
        ...
        <h2 style="float:right;"><?php echo $this->Html->link('Add Template',array('controller'=>'Certificates','action'=>'addtemplate'),array('class'=>'btn btn-xs btn-primary','data-toggle'=>'tooltip','tile'=>'Add Template')); ?></h2>
        <?php //} ?>
    </div>
