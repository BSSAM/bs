  ...
  <div class="col-sm-3 col-lg-12 subcontract_linear uncertainly_table">
    ...
    <table  class="table table-vcenter table-condensed table-bordered">
      ...
      <tbody class="calcul2_instrument_info">
          <?php if(isset($uncertaintydata)) { foreach($uncertaintydata as $k=>$uncertainty){ ?>
          <tr class="text-center">
          <td class="text-center"><?php echo $this->Temp->tagno($uncertainty['Tempuncertaintydata']['temp_uncertainty_id']); ?></td>
          <td class="text-center"><?php echo $this->Temp->instrumentname($uncertainty['Tempuncertaintydata']['temp_uncertainty_id']); ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['temp_uncertainty_id']; ?></td>
          ...
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['uref2_data1']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['uref3_data1']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['uacc1_data1']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['uacc2_data1']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['uacc3_data1']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['urefdivisor']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['uresdivisoranalog']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['uresdivisordigital']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['urepdivisor']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['divisor']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u1_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u2_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u3_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u4_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u5_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u6_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u7_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u8_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u9_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u10_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u11_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u12_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u13_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u14_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u15_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u16_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u17_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u18_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u19_data2']; ?></td>
          <td class="text-center"><?php echo $uncertainty['Tempuncertaintydata']['u20_data2']; ?></td>
          </tr>
          <?php } } ?>
      </tbody>
    </table>
