...
$('#status_call').change(function() {   // replace the ID_OF_YOUR_SELECT_BOX with the id to your select box given by Cake
       ...
       window.location = _ROOT + 'Tallyledgers/index/' + val;
    });    
});
</script>
<h1>
                    ...
                    <div class="block full">
                        <div class="block-title">
                            <h2>List Of Tally Ledger A/C <?php if($deleted_val == '0'): echo "- Active"; elseif($deleted_val == '1'): echo "- InActive"; endif;?></h2>
                        ...
                        <div class="table-responsive">
                            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if($tallyledger_list['Tallyledger']['is_deleted'] == 0):?> class="success" <?php else:?> class="error" <?php endif; ?>>
                                        ...
                                        <?php if($deleted_val == 1): ?>
                                             <td class="text-center" style="width: 250px;">
                                                <div class="btn-group ">
                                                    ...
                                                    <?PHP echo $this->Form->postlink('<i class="fa fa-undo"></i>',array('action'=>'retrieve',$tallyledger_list['Tallyledger']['id']),array('title'=>'Retrieve',
