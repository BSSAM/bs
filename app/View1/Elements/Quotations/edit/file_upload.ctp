<div class="block col-md-12">
                       ...
                       <div class="table-responsive">
                            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                ...
                                <tbody>
                                    <?PHP if(!empty($quotations_list['Document'])): ?>
                                    <?PHP foreach($quotations_list['Document'] as $document): ?>
						...
						echo $this->Html->link('<i class="gi gi-disk_save"></i>',
                                                array('controller'=>'Quotations','action'=>'attachment',
						$quotations_list['Quotation']['quotationno'],$document['document_name']),array('escape'=>false,'class'=>'btn btn-xs btn-default','data-toggle'=>'tooltip','title'=>'Download'));
                                            ?>
                                            <a href="javascript:void(0)" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-default document_delete" data-quotation_id="<?PHP echo $quotations_list['Quotation']['quotationno']; ?>" data-id="<?PHP echo $document['id']; ?>" data-name="<?PHP echo $document['document_name']; ?>"><i class="gi gi-bin"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?PHP endforeach; ?>
