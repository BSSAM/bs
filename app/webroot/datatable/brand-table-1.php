...
$columns = array(
    ...
    array( 'db' => 'brandname',  'dt' => 2 ),
    array( 'db' => 'branddescription',   'dt' => 3 ),
...
<i class="fa fa-pencil"></i></a>';
                ...
                if($_GET['delete']==1){
                    $cn .= '<a class="btn btn-xs btn-danger" title="" data-toggle="tooltip" href="'.$base_url.'brands/delete/'.$d.'" data-original-title="Delete">
