...
$primaryKey = 'id';
    ...
    $where1 = ' AND sals.is_deleted = 0 AND sals.is_trackcompleted = 1';
    $where2 = ' where sals.is_deleted = 0 AND sals.is_trackcompleted = 1';
...
$columns = array(
	...
	array( 'db' => 'sals.remarks',  'dt' => 10, 'field' => 'remarks' ),	
	array( 'db' => 'sals.id',     'dt' => 11 , 'field' => 'id' , 'formatter' => function( $d, $row ) {
            return '-';
        }),	
		
 	array( 'db' => 'cus.customername',  'dt' => 12, 'field' => 'customername' ),		
	
	array( 'db' => 'sals.attn' , 'field' => 'attn' , 'dt' => 13,'formatter' => function( $d, $row ) {
            
			return SSP::salesperson($d);
    } ),		
		
	array( 'db' => 'sals.branch_id' , 'field' => 'branch_id' , 'dt' => 14,'formatter' => function( $d, $row ) {
