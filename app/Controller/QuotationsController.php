...
$html .= '</tr>';
         ...
         if($k+1 == count($device_name)){  
                ...
                $html .= '<tr>
                    ...
                    <tr>
                         <td colspan="'.($count1+6).'" style="text-align:right;padding:10px;font-size:11px !important;border-left:1px  dashed #666;">GST ( '.$quotation_data['Customerspecialneed']['gst'].'% )</td>
