...
//        }
            ...
            switch ($module)
            {
                ...
                case 'invoice':
                  $random = $this->Random->find('first');
                    ...
                    $str1 = implode('-', $parts);
                    $this->Random->updateAll(array('Random.invoice'=>'"'.$str1.'"'),array('Random.id'=>1));  
                break;
                case 'clientpo':
                  $random = $this->Random->find('first');
                ...
                case 'subcon':
                  $random = $this->Random->find('first');
                    ...
                    $str1 = implode('-', $parts);
                    $this->Random->updateAll(array('Random.subcon'=>'"'.$str1.'"'),array('Random.id'=>1));  
                break;
                case 'uncertain':
                  $random = $this->Random->find('first');
                    ...
                    $str1 = implode('-', $parts);
                    $this->Random->updateAll(array('Random.uncertain'=>'"'.$str1.'"'),array('Random.id'=>1));  
                break;
                case 'purchaseorders':
                  $random = $this->Random->find('first');
                    ...
                    $str1 = implode('-', $parts);
                    $this->Random->updateAll(array('Random.purchaseorders'=>'"'.$str1.'"'),array('Random.id'=>1));  
                break;
                case 'certificateno':
                    $random = $this->Random->find('first');
                    ...
                    $str1 = implode('-', $parts);
                    $this->Random->updateAll(array('Random.certificateno'=>'"'.$str1.'"'),array('Random.id'=>1));  
                break;
            }
            return $str1;
        }
        ...
        public function is_delivered($delivery_order_id=NULL,$cd_date=NULL)
        {
            //pr($cd_date);exit;
            $ready = $this->ReadytodeliverItem->find('first',array('conditions'=>array('ReadytodeliverItem.id'=>$delivery_order_id)));
            $del_id = $ready['ReadytodeliverItem']['deliveryorder_id'];
            ...
            if($arr != '')
            {
                ...
                foreach($arr as $import_order_by)
                {
                    $this->Description->updateAll(array('Description.is_delivered'=>1),array('Description.order_by'=>$import_order_by,'Description.salesorder_id'=>$sal_id,'Description.status'=>1));
                }
                $this->ReadytodeliverItem->updateAll(array('ReadytodeliverItem.is_delivered'=>1,'ReadytodeliverItem.delivered_date'=>"'.$cd_date.'"),array('ReadytodeliverItem.id'=>$delivery_order_id));
            }
        }
         ...
         public function add_onsite_instruments($data=NULL,$quotation_id=NULL)
        {
            ...
            foreach($data as $onsite_ins):
                ...
                $this->request->data['OnsiteInstrument']['title1_val']              =   $onsite_ins['Device']['title1_val'];
                $this->request->data['OnsiteInstrument']['title2_val']              =   $onsite_ins['Device']['title2_val'];
                $this->request->data['OnsiteInstrument']['title3_val']              =   $onsite_ins['Device']['title3_val'];
                $this->request->data['OnsiteInstrument']['title4_val']              =   $onsite_ins['Device']['title4_val'];
                $this->request->data['OnsiteInstrument']['title5_val']              =   $onsite_ins['Device']['title5_val'];
                $this->request->data['OnsiteInstrument']['title6_val']              =   $onsite_ins['Device']['title6_val'];
                $this->request->data['OnsiteInstrument']['title7_val']              =   $onsite_ins['Device']['title7_val'];
                $this->request->data['OnsiteInstrument']['title8_val']              =   $onsite_ins['Device']['title8_val'];
