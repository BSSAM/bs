     ...
     <table width="98%" cellpadding="1" cellspacing="1"  style="width:100%;margin-top:20px;">
          <tr>
               ...
               <td width="45%" style="border:1px solid #000;width:50%;padding:0"><table width="230" cellpadding="0" cellspacing="0">
                         <tr>
                              <td  width="260" colspan="3" style="padding:5px 0;"><div align="center" style="font-size:28px;border-bottom:1px solid #000;width:100%;padding:5px 0;font-weight:bolder;  position:relative;top:-10px;">'.$subcontractdo_details['Subcontractdo']['subcontract_dono'].'</div></td>
                         </tr>
                         <tr>
...
$html .= '</div>'; 
    ...
    {    
        ...
        if($file_type == 'pdf')
        {
            ...
            $this->dompdf->render();
            $this->dompdf->stream("SubconDO-".$filename.".pdf");
