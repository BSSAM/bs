...
<?PHP echo $this->Form->input('no_to_tackle', array('type' => 'hidden', 'name' => 'no_to_tackle', 'value' => $data_sal['Salesorder']['id'])); ?>
<?PHP echo $this->Form->input('ack_type', array('type' => 'hidden', 'name' => 'ack_type', 'value' => $ack_type)); ?>
    ...
    <div class="col-sm-3">
        <div class="block">
            <dl>
                ...
                <dd class="word_break">
                    <?PHP echo $quo_no; ?>
                    <br><span class="label label-info">Quantity : <?PHP echo $quotation_instrument_count; ?></span>
                </dd>
            </dl>
        </div>
    </div>
...
<!--                        <dd class="word_break"><?PHP // echo $v; ?></dd>
               ...
               <?PHP if (!empty($delivery_order_no)): ?>
                <dd class="word_break">
                    <?PHP echo $delivery_order_no; ?>
                    <br><span class="label label-info">Quantity : <?PHP echo $deliveryorder_instrument_count; ?></span>
                </dd>
                    <?PHP //endforeach; ?>
                <?PHP else: ?>
...
if ($data_sal['Salesorder']['is_poapproved'] != 1):
    ?>
...
<?php if($invoicetype == 1){ ?><!---------------------  PO Full Invoice    --->

<?PHP echo $this->Form->create('Clientposapproval', array('url' => 'quotation_po_update', 'class' => 'form-horizontal')); ?>
<?PHP echo $this->Form->input('no_to_tackle', array('type' => 'hidden', 'name' => 'no_to_tackle', 'value' => $data_quo[0]['Quotation']['ref_no'])); ?>
<?PHP echo $this->Form->input('ack_type', array('type' => 'hidden', 'name' => 'ack_type', 'value' => $ack_type)); ?>
<?PHP echo $this->Form->input('title_name', array('type' => 'hidden', 'name' => 'title_name', 'value' => $title_name)); ?>
<?php echo $this->Form->input('invoice_type',array('type'=>'hidden', 'name'=>'invoice_type','value'=>$invoicetype)); ?>

<h4 class="sub-header text-center">Customer Details - <strong><?PHP echo $data_quo[0]['Customer']['Customertagname'] . "(" . $data_quo[0]['Customer']['id'] . ")"; ?> </strong></h4>
...
<?PHP endforeach; ?>
    ...
    <div class="col-sm-3">
        <div class="block"> 
            <dl>
                <dt>Phone</dt>
                <dd class="word_break"><?PHP echo $data_quo[0]['Customer']['phone']; ?></dd>                                                                  
            </dl>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="block"> 
            <dl>
                <dt>Fax</dt>
                <dd class="word_break"><?PHP echo $data_quo[0]['Customer']['fax']; ?></dd>                                                                  
            </dl>
        </div>
    </div>
    <div class="col-sm-3">
...
<h4 class="sub-header text-center">Job Details - <strong>( <?PHP echo $data_quo[0]['Quotation']['track_id']; ?> )</strong></h4>
<div class="row">
    <div class="col-sm-3">
        <div class="block">
            <dl>
        ...
        <div class="block">
            <dl>
                <dt>Sales Order</dt>
                    <dd class="word_break">
                        <?PHP
                        echo $salesorder_id; //echo "&nbsp";
                        ?>
                    </dd>
                    <dd class="word_break"><span class="label label-info">Quantity : <?PHP echo $salesorder_instrument_count; ?></span> </dd>
            </dl>
        </div>
    </div>
...
<?php
//if($data['Quotation']['is_assign_po']!=1 && $data['Quotation']['po_generate_type']!="Manual"): 
if ($data_quo[0]['Quotation']['is_poapproved'] != 1):
    ?>
    <div class="form-group form-actions">
        <div class="col-xs-12 text-right">
            <?php if ($title_name == 'Approve'): ?>
