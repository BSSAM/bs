 <h1>
                                <i class="gi gi-user"></i>Edit Sales Person
                            </h1>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <!-- Basic Form Elements Content -->
                                 <?php echo $this->Form->create('Salesperson',array('class'=>'form-horizontal form-bordered','id'=>'form-salesperson-add')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-2 control-label" for="val_salespersoncode">Sales Person Code</label>
                                        <div class="col-md-4">
                                            <?php echo $this->Form->input('salespersoncode', array('id'=>'val_salespersoncode','class'=>'form-control','placeholder'=>'Enter the Sales Person Code','label'=>false,'name'=>'salespersoncode')); ?>
                                        </div>
                            ...
                            <script> var UiProgress = function() {
                                ...
                                return {
                                    init: function() {
                                        ...
                                        $.bootstrapGrowl('Sales Person Name is Already Exists!', {
                                            type: 'danger',
                                            allow_dismiss: true
                                        });
                                        
                                        $(this).prop('disabled', true);
                                        $('#val_salesperson').focus();
                                    }
                                };
                            }();
