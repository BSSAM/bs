...
class CanddHelper extends AppHelper 
{
    ...
    public function get_task($cd_date=NULL)
    {
        ...
        $collectioncount_basedon_date    =    $this->Candd->find('count',array('conditions'=>array('Candd.cd_date'=>$cd_date,'Candd.is_deleted'=>0)));
    ...
    public function get_collection_count($cd_date=NULL)
    {
        APP::import('Model','Candd');
        $this->Candd  =   new Candd();
        $collectioncount_basedon_date    =    $this->Candd->find('count',array('conditions'=>array('Candd.cd_date'=>$cd_date,'Candd.purpose'=>'Collection')));
