...
//    }); 
	...
	//"sScrollX": "100%",
        ...
        "ajax": _ROOT+"datatable/job/quotation-table-1.php?edit=<?php echo $userrole_cus['edit'];?>&delete=<?php echo $userrole_cus['delete'];?>"
        });
...
<h1>
                    ...
                    <div class="block full">
                        <div class="block-title">
                            ...
                            <h2 style="float:right;"><?php echo $this->Html->link('Add Quotation',array('controller'=>'Instruments','action'=>'add'),array('class'=>'btn btn-xs btn-primary','data-toggle'=>'tooltip','tile'=>'Add Instrument')); ?></h2>
                            <?php } ?>
                        </div>
