                ...
                <div class="panel-body panel-body-nopadding">
                    ...
                    <div id="basicWizard" class="basic-wizard">
                        <ul class="nav nav-pills nav-justified " data-toggle="tabs" id="tabs">
                            <li class="active"><a href="#tab1" data-toggle="tab"><span>Step 1:</span> Overall File Upload</a></li>
                            <li class=""><a href="#tab2" data-toggle="tab"><span>Step 2:</span> Individual File Upload</a></li>
                       </ul>
