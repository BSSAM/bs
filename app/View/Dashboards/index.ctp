                    ...
                    <div class="block">
                        <div class="block-title">
                            <ul class="nav nav-tabs" data-toggle="tabs">
                                ...
                                {
                                ?>
                                <li><a href="#job_approval">Job Approval <span class="badge animation-floating"><?php echo ($log_activity_customer_count)+($log_activity_customertag_count)+($log_activity_salesorder_count)+($log_activity_cdinfo_count)+($log_activity_deliveryorder_count)+($log_activity_quotation_count)+($log_activity_client_count)+($log_activity_prpur_count)+($log_activity_prman_count)+($log_activity_prsuper_count)+($log_activity_invoice_count)+($log_activity_subcon_count); ?></span></a></li>
                                <?php } 
