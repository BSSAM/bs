...
<!--                            <div class="text-center">
                            ...
                            <!-------------------------------  SubCon ----------------------------------------------->
                            <!---------------------------------------------------------------------------------------->
                            <div class="tab-pane" id="subcon">
                                <div class="block full">
                                <div class="table-responsive">
                                <table id="subcon_cannd" class="table table-vcenter table-condensed table-bordered">
                                    <?PHP if (!empty($log_activity_subcon)): ?>
                                    <thead>
                                        <th>Flag</th>
                                        <th>Name(Details)</th>
                                        <th>Approval</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($log_activity_subcon as $logactivity_subcon_list) :?> 
                                        <tr>
                                            <td class="text-center" style="width: 80px;"><?php echo $this->Html->image('letters/letters-pr.jpg', array('alt' => 'SubCon','class'=>'')); ?></td>
                                            <td>
                                                <h4><a href="javascript:void(0)"><strong><?PHP echo $logactivity_subcon_list['Logactivity']['logname'] ?></strong></a> <br><small><?PHP echo $logactivity_subcon_list['Logactivity']['logactivity'] ?>   -  <em><?PHP echo $logactivity_subcon_list['Logactivity']['logno'] ?></em></small></h4>
                                            </td>
                                            <td class="text-center ">
                                           <?PHP if($logactivity_subcon_list['Logactivity']['logname'] == 'SubCon'){ ?>
                                            <?PHP  echo $this->html->link('Approve',array('controller'=>'Subcontractdos','action'=>'edit',$logactivity_subcon_list['Logactivity']['logid']),array('class'=>'btn btn-xs btn-primary')) ?>
                                                
                                           <?php }?>
                                           
                                            
                                            </td>
                                            <td class="">by <?PHP echo $logactivity_subcon_list['User']['username'] ?><br><small><?PHP echo $logactivity_subcon_list['Logactivity']['created'] ?></small></td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center">
                                                <i class="gi gi-keys"></i> Oops... No Sub-Contract Do Approval Available
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php endif; ?>
                            ...
                            <div class="tab-pane" id="onsite">
                                ...
                                <table id="onsite" class="table table-vcenter table-condensed table-bordered">
                                    <?PHP if (!empty($log_activity_onsite)): ?>
                                    <thead>
                                        <th>Flag</th>
                                        <th>Name(Details)</th>
                                        <th>Approval</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($log_activity_onsite as $logactivity_onsite_list) :?> 
                                        <tr>
                                            <td class="text-center" style="width: 80px;"><?php echo $this->Html->image('letters/letters-pr.jpg', array('alt' => 'SubCon','class'=>'')); ?></td>
                                            <td>
                                                <h4><a href="javascript:void(0)"><strong><?PHP echo $logactivity_onsite_list['Logactivity']['logname'] ?></strong></a> <br><small><?PHP echo $logactivity_onsite_list['Logactivity']['logactivity'] ?>   -  <em><?PHP echo $logactivity_onsite_list['Logactivity']['logno'] ?></em></small></h4>
                                            </td>
                                            <td class="text-center ">
                                           <?PHP if($logactivity_onsite_list['Logactivity']['logname'] == 'Onsite'){ ?>
                                            <?PHP  echo $this->html->link('Approve',array('controller'=>'Onsites','action'=>'edit',$logactivity_onsite_list['Logactivity']['logid']),array('class'=>'btn btn-xs btn-primary')) ?>
                                                
                                           <?php }?>
                                           
                                            
                                            </td>
                                            <td class="">by <?PHP echo $logactivity_onsite_list['User']['username'] ?><br><small><?PHP echo $logactivity_onsite_list['Logactivity']['created'] ?></small></td>
                                        </tr>
