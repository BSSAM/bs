...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php
        echo $this->Form->input('PreqCustomerSpecialNeed.projectname', array('id' => 'val_projectname', 'class' => 'form-control',
...
<div class="form-group">
    ...
    <div class="col-md-4">
<?php
echo $this->Form->input('PreqCustomerSpecialNeed.gst', array('id' => 'val_gst', 'class' => 'form-control',
...
?>
    ...
    <div class="col-md-4">
<?php
echo $this->Form->input('PreqCustomerSpecialNeed.currency_value', array('id' => 'val_currency_value', 'class' => 'form-control',
...
<div class="form-group">
    ...
    <div class="col-md-4">
<?php
echo $this->Form->input('PreqCustomerSpecialNeed.additionalcharge_id', array('id' => 'val_additional_service_charge', 'class' => 'form-control select-chosen', 'type' => 'select',
...
?>
    ...
    <div class="col-md-4">
<?php
echo $this->Form->input('PreqCustomerSpecialNeed.additional_service_value', array('id' => 'val_service_charge', 'class' => 'form-control',
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php
        echo $this->Form->input('PreqCustomerSpecialNeed.remarks', array('id' => 'val_remarks', 'class' => 'form-control',
    ...
    <div class="col-md-4">
    <?php
    echo $this->Form->input('PreqCustomerSpecialNeed.service_id', array('id' => 'val_service_id', 'class' => 'form-control select-chosen', 'type' => 'select',
