<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('PurchaseRequisition.prequistionno', array('id'=>'val_quotationno','class'=>'form-control','readonly'=>'readonly','label'=>false,'value'=>$purchase_requistion_list['PurchaseRequisition']['prequistionno'])); ?>
    </div>
