...
<div class="table-responsive">
    <table id="seven-datatable" class="table table-vcenter table-condensed table-bordered">
        <thead>
            <tr>
                ...
                <td class="text-center">
                    ...
                    <div class="btn-group">
                       <?php //echo $quotation_list['Quotation']['po_generate_type']; ?>
                                ...
                                <a href="#modal-user-settings-quo" data-toggle="modal" class="btn btn-alt btn-xs btn-success client_po_quotation_update_quo" data-placement="bottom" title="Update" data-id="<?PHP echo $quotation_list['Quotation']['id'] ?>">Update</a>
                    ...
                    <div class="btn-group">
                       <?php //echo $quotation_list['Quotation']['po_generate_type']; ?>
                                <?PHP $invoice_type = $this->ClientPO->getinvoice_type($quotation_list['Customer']['id']); ?>
                                <a href="#modal-user-settings-quo" data-toggle="modal" class="btn btn-alt btn-xs btn-success client_po_quotation_update_quo" data-placement="bottom" title="Approve" data-id="<?PHP echo $quotation_list['Quotation']['id'] ?>">Approve</a>
...
<span class="label label-five">Ma</span> - Manual PO Updated
      ...
      <div id="modal-user-settings-quo" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
