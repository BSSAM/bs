<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('Salesorder.salesorderno', array('id'=>'val_salesorderno','class'=>'form-control','readonly'=>'readonly','label'=>false,'value'=>$salesorder['Salesorder']['salesorderno'])); ?>
    </div>
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('Salesorder.customername', 
                array('id'=>'val_customer','class'=>'form-control','placeholder'=>'Enter the Customer Name','label'=>false,
                    'autoComplete'=>'off','type'=>'text','name'=>'sales_customername','value'=>$salesorder['Customer']['Customertagname'],'readonly'=>'readonly')); ?>
        <div id="result"></div>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('Salesorder.fax', array('id'=>'val_fax','class'=>'form-control','label'=>false,'placeholder'=>'Enter the Fax Number','readonly'=>'readonly')); ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('Salesorder.priority', array('id' => 'val_priority', 'class' => 'select-chosen form-control',
