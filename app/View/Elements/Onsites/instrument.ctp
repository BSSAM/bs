...
$("#search_cusinstrument").hide();
    ...
    { 
        ...
        var customer_id = $('#customer_id').val();
        //alert(instrument);
        var device_id = $('#OnsiteInstrumentId').val();
        //alert(customer_id);
        ...
        if(device_id!='')
        {
            $.ajax({
            type: "POST",
            url: path_url+"Onsites/model_search",
            data: dataString,
            cache: false,
            success: function(html)
            {
...
//        $('#val_account_service').prop('required', true);
       ...
       $scope.show_instrument = function()
        {
        var quo_id = $('#onsite_input_search').val();
        ...
        $scope.pagination = function(){
           ...
           //console.log($scope.no_of_page);
            ...
            $http.post(path_url+'Onsites/instrument/',{
                       quo_id:quo_id,
...
//            
        $scope.title_change = function()
        {
                ...
                var instrument_title=$('#val_title').val();
                    ...
                    $http.post(path_url+'Onsites/add_instrument/',{
    ...
    //                    "instrument_quantity":instrument_quantity,
                        ...
                        "quotationno":quotationno
                         ...
                         $.each(data,function(k,v){
                            ...
                            setTimeout(
                                    function(){
                            $('.edit_title1').editable(path_url+'/Onsites/update_title1', {
                                    id        : 'device_id',
                                    name      : 'title1',
                                    type      : 'text',
                                    cancel    : 'Cancel',
                            ...
                            $('.edit_title2').editable(path_url+'/Onsites/update_title2', {
                                    id        : 'device_id',
                                    name      : 'title2',
                                    type      : 'text',
                                    cancel    : 'Cancel',
                            ...
                            $('.edit_title3').editable(path_url+'/Onsites/update_title3', {
                                    id        : 'device_id',
                                    name      : 'title3',
                                    type      : 'text',
                                    cancel    : 'Cancel',
                            ...
                            $('.edit_title4').editable(path_url+'/Onsites/update_title4', {
                                    id        : 'device_id',
                                    name      : 'title4',
                                    type      : 'text',
                                    cancel    : 'Cancel',
                            ...
                            $('.edit_title5').editable(path_url+'/Onsites/update_title5', {
                                    id        : 'device_id',
                                    name      : 'title5',
                                    type      : 'text',
                                    cancel    : 'Cancel',
                            ...
                            $('.edit_title6').editable(path_url+'/Onsites/update_title6', {
                                    id        : 'device_id',
                                    name      : 'title6',
                                    type      : 'text',
                                    cancel    : 'Cancel',
                            ...
                            $('.edit_title7').editable(path_url+'/Onsites/update_title7', {
                                    id        : 'device_id',
                                    name      : 'title7',
                                    type      : 'text',
                                    cancel    : 'Cancel',
                            ...
                            $('.edit_title8').editable(path_url+'/Onsites/update_title8', {
                                    id        : 'device_id',
                                    name      : 'title8',
                                    type      : 'text',
                                    cancel    : 'Cancel',
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('call_location', array('id'=>'val_call_location','class'=>'form-control error-custom','ng-model' => 'loca_quo_model',
                                                'label'=>false,'name'=>'call_location','type'=>'select','options'=>array('onsite'=>'On Site'),'empty'=>'Select Call Location')); ?>
