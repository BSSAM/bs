<script>
    var upload_url    =   '<?PHP echo Router::url('/Deliveryorders/file_upload/'.$salesorderno,true); ?>';
    var delete_url  =  '<?PHP echo Router::url('/Deliveryorders/delete_document/'.$salesorderno,true); ?>';
</script>
