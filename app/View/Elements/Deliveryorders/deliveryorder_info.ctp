...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('Deliveryorder.delivery_order_date', array('id'=>'del_order_date','class'=>'form-control input-datepicker-close','data-date-format'=>'yyyy-mm-dd','label'=>false,'value'=>date('Y-m-d'))); ?>
    </div>
</div>
<div class="form-group">
