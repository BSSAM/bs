<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('Reqpurchaseorder.prequistionno', array('id'=>'val_quotationno','class'=>'form-control','readonly'=>'readonly','label'=>false,'value'=> $prequistionno)); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('Reqpurchaseorder.payment_term', array('id'=>'val_payment_term','class'=>'form-control','label'=>false,
...
<div class="form-group">
 <label class="col-md-2 control-label" for="val_customer">Select Instrument For</label>
    <div class="col-md-12">
        <?php echo $this->Form->input('Reqpurchaseorder.instrument_type_id', array('id'=>'val_customer','class'=>'form-control select-chosen','type'=>'select',
                                                'label'=>false,'empty'=>'-- Select instrument For --')); ?>
    </div>
</div>
