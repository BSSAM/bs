 <h1>
                                <i class="gi gi-user"></i>Edit Location
                            </h1>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <!-- Basic Form Elements Content -->
                                 <?php echo $this->Form->create('Location',array('class'=>'form-horizontal form-bordered','id'=>'form-location-add')); ?>
                                
                                    <div class="form-group">
                                       
                                        <label class="col-md-2 control-label" for="val_locaionname">Location Name <span class="text-danger">*</span></label>
                                        <div class="col-md-4">
                            ...
                            <script> var UiProgress = function() {
                                ...
                                return {
                                    init: function() {
                                        ...
                                        $.bootstrapGrowl('Location Already Exists!', {
                                            type: 'danger',
                                            allow_dismiss: true
                                        });
                                        
                                        $(this).prop('disabled', true);
                                        $('#val_locationname').focus();
                                    }
                                };
                            }();
