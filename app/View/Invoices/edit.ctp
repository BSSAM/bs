...
<div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="block-title clearfix">
                                    ...
                                    <h2 class="pull-right ">
                                       Track Id : <?PHP echo $invoices['Invoice']['track_id']; ?>
                                    </h2>
                                </div>
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('customer_name', array('id'=>'inv_customer','class'=>'form-control','readonly'=>'readonly','label'=>false,'name'=>'inv_customer_name','value'=>$invoices['Invoice']['customername'])); ?>
    </div>
    <label class="col-md-2 control-label" for="inv_dueamount">Due Amount</label>
    <div class="col-md-4">
        <?php echo $this->Form->input('due_amount', 
                array('id'=>'inv_dueamount','class'=>'form-control','label'=>false,'type'=>'text','readonly'=>'readonly','value'=>$invoices['Invoice']['due_amount'])); ?>
    </div>
</div>
<div class="form-group">
<!--      <label class="col-md-2 control-label" for="del_address_id">Delivery Addresses List</label>
    ...
    <div class="col-md-4">
        <?php echo $this->Form->textarea('regaddress', array('class'=>'form-control',
                                               'placeholder'=>'Enter the Delivery Address','label'=>false,'rows'=>4,'cols'=>30,'readonly'=>'readonly','value'=>$invoices['Invoice']['regaddress'])); ?>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('contactpersonname', array('id'=>'inv_contactpersonname',
            'class'=>'form-control','label'=>false,'readonly'=>'readonly','value'=>$invoices['Invoice']['contactpersonname'])); ?>
    </div>
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('email', array('id'=>'inv_email','class'=>'form-control',
                                                'label'=>false,'readonly'=>'readonly','value'=>$invoices['Invoice']['email'])); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('phone', array('id'=>'inv_phone','class'=>'form-control',
                                                'label'=>false,'readonly'=>'readonly','value'=>$invoices['Invoice']['phone'])); ?>
       
    </div>
    <label class="col-md-2 control-label" for="inv_fax">Fax</label>
    <div class="col-md-4">
        <?php echo $this->Form->input('fax', array('id'=>'inv_fax','class'=>'form-control','label'=>false,'readonly'=>'readonly','value'=>$invoices['Invoice']['fax'])); ?>
    </div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label" for="inv_del_order_no">Delivery Order No</label>
    <div class="col-md-4">
        <?php echo $this->Form->input('delivery_order_no', array('id'=>'inv_del_order_no','class'=>'form-control','label'=>false,'value'=>$invoices['Invoice']['deliveryorder_id'],'readonly'=>'readonly')); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->input('po_reference_no', array('id'=>'inv_ref_no','class'=>'form-control','label'=>false,'readonly'=>'readonly','value'=>$invoices['Invoice']['ref_no'])); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $this->Form->textarea('remarks', array('id'=>'inv_remarks','class'=>'form-control',
                                               'label'=>false,'rows'=>6,'cols'=>30,'value'=>$invoices['Invoice']['remarks'],'readonly'=>'readonly')); ?>
    </div>
    <label class="col-md-2 control-label" for="inv_service_type">Service Type</label>
    <div class="col-md-4">
        <?php echo $this->Form->input('service_type', array('id'=>'inv_service_type','class'=>'form-control','value'=>$invoices['Invoice']['service_type'],'label'=>false,'readonly'=>'readonly')); ?>
        <div id="result">
        </div>
    </div>
</div>  
<div class="form-group">
    ...
    <div class="col-md-12">
        <?php echo $this->Form->input('val_instrument_type', array('class'=>'form-control','type'=>'text',
                                                'label'=>false,'value'=>$invoices['instrument_type']['invoice'],'readonly'=>'readonly')); ?>
    </div>
</div>
...
<table id="beforedo-datatable" class="table table-vcenter table-condensed table-bordered">
    ...
    <div class="form-group form-actions">
        ...
        <?php if($user_role['app_invoice']['view'] == 1 && $invoices['Invoice']['is_approved']==0 && $invoices['Invoice']['is_poapproved']!=1 && $invoices['Invoice']['acknowledgement_type_id']==2): ?>
        <?php  echo $this->Form->button('<i class="fa fa-angle-right"></i> Approve',array('type'=>'button','class'=>'btn btn-sm btn-primary approve_invoice','escape' => false)); ?>
            <?php endif; ?>
        <?php if($user_role['app_invoice']['view'] == 1 && $invoices['Invoice']['is_approved']==0 && $invoices['Invoice']['is_poapproved']==0 && $invoices['Invoice']['acknowledgement_type_id']==2): ?>
