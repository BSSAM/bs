...
$('#status_call').change(function() {   // replace the ID_OF_YOUR_SELECT_BOX with the id to your select box given by Cake
       ...
       window.location = _ROOT + 'Assigns/index/' + val;
    });    
});
</script>
<h1>
                    ...
                    <div class="block full">
                        <div class="block-title">
                            <h2>List Of Assigned To <?php if($deleted_val == '0'): echo "- Active"; elseif($deleted_val == '1'): echo "- InActive"; endif;?></h2>
                        ...
                        <div class="table-responsive">
                            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr <?php if($assign_list['Assign']['is_deleted'] == 0):?> class="success" <?php else:?> class="error" <?php endif; ?>>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                 ...
                                                 <?php echo $this->Html->link('<i class="fa fa-pencil"></i>',array('action'=>'edit',$assign_list['Assign']['id']),array('data-toggle'=>'tooltip','title'=>'Edit','class'=>'btn btn-xs btn-default','escape'=>false)); ?>
                                                 <?php } ?>
                                                 <?php if($userrole['delete']==1){ ?>
                                                <?php echo $this->Form->postLink('<i class="fa fa-times"></i>',array('action'=>'delete',$assign_list['Assign']['id']),array('data-toggle'=>'tooltip','title'=>'Delete','class'=>'btn btn-xs btn-danger','escape'=>false,'confirm'=>'Are you Sure?')); ?>
                                                 <?php } ?>
                                            </div>
                                        </td>
                                        <?php endif; ?>
                                        <?php if($deleted_val == 1): ?>
                                             <td class="text-center" style="width: 250px;">
                                                <div class="btn-group ">
                                                    ...
                                                    <?PHP echo $this->Form->postlink('<i class="fa fa-undo"></i>',array('action'=>'retrieve',$assign_list['Assign']['id']),array('title'=>'Retrieve',
