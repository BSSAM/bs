...
<!--            <div class="description_list">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <?php echo $this->Form->input('Purchaseorder.purchaseorder_date', array('id'=>'pur_order_date','class'=>'form-control input-datepicker-close','data-date-format'=>'dd-M-yyyy','label'=>false)); ?>
                </div>
            </div>
