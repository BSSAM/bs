        ...
        <table id="one-datatable" class="table table-vcenter table-condensed table-bordered dataTable6">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?PHP $count_p = '' ; foreach ($salesorder['Description'] as $desc):  if($desc['processing'] == '1' && $desc['checking'] != '1'): $count_p++; endif; endforeach; if($count_p == ''): echo '0'; else: echo $count_p; endif;?></td>
                    ...
                    <td class="text-center"><?PHP $count_r = '' ; foreach ($salesorder['Description'] as $desc):  if($desc['is_delivered'] == '1'): $count_r++; endif; endforeach; if($count_r == ''): echo '0'; else: echo $count_r; endif;?></td>
                    <td class="text-center">
                        <div class="btn-group">
